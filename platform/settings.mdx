...
| **Pulse Social Scheduler** | Autonomous content queue scheduling and distribution to LinkedIn, Facebook, Instagram, and Threads. See [Social publishing dispatcher](/platform/social-publishing) for the end-to-end flow and required credentials. | AgentLab Social Dispatch API |
