...
- **Under-the-hood library upgrades.** Core libraries powering forms, dialogs, menus, tables, charts, and background data fetching moved to their latest patch and minor releases. You get faster interactions, better tree-shaking (smaller downloads), and improved React Server Components compatibility. No changes to how the app looks or works day-to-day. See the [Quickstart](/quickstart) to get started.
