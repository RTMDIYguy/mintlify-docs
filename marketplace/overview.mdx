...
Beta-only apps check your beta enrollment before launching. If you are not enrolled at the required tier, the Marketplace prompts you to enroll in the app's beta program first, then launches the app after enrollment succeeds. Roadmap apps (Market Marksman Investor's, Insurance, and Legal editions) are listed for visibility but cannot be launched yet.

## Workspace entitlements

Select **View Workspace Entitlements** to open the entitlements drawer. It lists every playbook currently mounted in your workspace along with the active entitlement count, so you can audit what your workspace is paying for and unmount anything you no longer need.
